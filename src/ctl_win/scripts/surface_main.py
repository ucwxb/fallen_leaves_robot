...
class MainWidget(QWidget):
    ...
    def __InitBtn(self):
        ...
        self.__BtnCtl.btn_dict["Manual"].clicked.connect(self.Manual)
    ...
    def Manual(self):
        send_cmd, ok=QInputDialog.getText(self, '提示', '请输入：')
        send_cmd = int(send_cmd)
        if send_cmd and ok:
            self.manual_topic.publish(manual_topic(send_cmd))
